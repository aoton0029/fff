...
class LaborTransferData(db.Model):
    ...
    account_code: Mapped[str] = mapped_column('勘定科目コード', String(30), ForeignKey('mst_勘定科目.勘定科目コード'), nullable=False)
    cost_center: Mapped[Optional[str]] = mapped_column('原価センタ', String(30), ForeignKey('mst_原価センタ.原価センタコード'))
    ...
    wbs: Mapped[Optional[str]] = mapped_column('WBS', String(100), ForeignKey('mst_WBS.WBSコード'))
