...
allocation_bp = Blueprint('allocation', __name__, template_folder='../templates')
...
@allocation_bp.route('/upload', methods=['POST'])
@login_required
def upload():
    form = UploadForm()
...
@allocation_bp.route('/detail/<int:batch_id>')
@login_required
...
@allocation_bp.route('/delete/<int:batch_id>', methods=['DELETE', 'POST'])
@login_required
